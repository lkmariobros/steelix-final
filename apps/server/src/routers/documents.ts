...
export const documentsRouter = router({
	...
	upload: protectedProcedure
		...
		.mutation(async ({ ctx, input }) => {
			...
			if (!supabaseAdmin) {
				throw new Error(
					"Document upload is currently unavailable. Supabase configuration is missing.",
				);
			}
	...
	delete: protectedProcedure
		...
		.mutation(async ({ ctx, input }) => {
			...
			if (!supabaseAdmin) {
				throw new Error(
					"Document deletion is currently unavailable. Supabase configuration is missing.",
				);
			}
