			...
			<DialogContent className="max-h-[90vh] gap-0 overflow-hidden p-0 sm:max-w-lg">
				<DialogHeader className="border-b px-6 py-4 text-left">
					...
					<DialogDescription className="text-left text-sm leading-relaxed">
						Use the same column headers as <strong>Export CSV</strong> (Name,
						Email, Phone, etc.). Required fields per row:{" "}
						<strong>Name</strong>, <strong>Email</strong>, and{" "}
						<strong>Phone</strong>. Existing email or phone numbers are skipped.
					</DialogDescription>
				</DialogHeader>
